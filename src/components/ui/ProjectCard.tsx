...
const WATERMARK_COLORS = [
  ...
  "from-teal-500/10 to-indigo-500/10",
  "from-indigo-500/10 to-teal-500/10",
];

const GRADIENT_BORDERS = [
  "from-indigo-500 via-teal-400 to-indigo-500",
  "from-teal-400 via-indigo-500 to-teal-400",
  "from-indigo-500 via-teal-400 to-indigo-500",
];
...
export function ProjectCard({ project, index, onClick }: ProjectCardProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "group relative cursor-pointer overflow-hidden rounded-xl border border-slate-800/60 bg-slate-900/50 p-6 transition-all duration-300 hover:border-transparent",
      )}
    ...
    >
      ...
      <div
        ...
        style={{
          padding: "1px",
          background: `conic-gradient(from var(--border-angle, 0deg), transparent, transparent, ${["rgba(99,102,241,0.4)", "rgba(45,212,191,0.4)", "rgba(99,102,241,0.4)"][index]}, transparent 80%)`,
